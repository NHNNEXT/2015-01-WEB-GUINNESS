...
ALTER TABLE NOTES CHANGE createDate noteTargetDate Not Null;
...
ALTER TABLE ALARMS CHANGE createDate alarmsCreateDate DATETIME DEFAULT CURRENT_TIMESTAMP;
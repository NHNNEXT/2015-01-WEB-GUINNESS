...
var setEventListener = function() {
	setResetEvent("join-userEmail");
	setResetEvent("join-userName");
	setResetEvent("join-userPassword");
	...
	document.querySelector("#join-userEmail").addEventListener("focusout", function(e) {
		...
		if(regex.test(value) === false) {
			joinCheck.setErrorMessageElement({
				element: "join-userEmail-message",
				status: "block",
	...
	document.querySelector("#join-userPassword").addEventListener("focusout", function(e) {
		...
		if(regex.test(value) === false) {
			joinCheck.setErrorMessageElement({
				element: "join-userPassword-message",
				status: "block",
...
var setResetEvent = function(elementName) {
